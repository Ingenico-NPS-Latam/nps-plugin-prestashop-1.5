		...
		<div class=content>
			...
			<div class=nav>
				...
				foreach($this->getOperations() as $op => $data){
				    ...
				    <a href='#' onclick='popout()'><font color='#333333'><b>Close</b></font></a><br><br>";
				    foreach($data as $donnie => $marie){ // loop through opdata
						if($donnie == 'input' || $donnie == 'output'){ // show input/output data
						    $b .= "<font color='#333333'>".ucfirst($donnie).':</font><br>';
						    ...
						    $b .= "<font color='#333333'>".ucfirst($donnie).":</font> $marie<br>";
						}
				    }
					$b .= '</div>';
				}
