...
class wsdl extends nusoap_base {
    ...
    */
    function webDescription(){
		...
		<style type="text/css">
		    body    { font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif; color: #000000; background-color: #ffffff; margin: 0px 0px 0px 0px; }
		    p       { font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif;; color: #000000; margin-top: 0px; margin-bottom: 12px; }
		    pre { background-color: silver; padding: 5px; font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif;; font-size: x-small; color: #000000;}
			...
			background-color: #435370; width: 105%; margin-left: 0px;
			padding-top: 10px; padding-bottom: 10px; padding-left: 15px;}
		    .hidden {
			position: absolute; visibility: hidden; z-index: 200; left: 250px; top: 100px;
			font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif;; overflow: hidden; width: 600;
		...
		<div class=content>
			<br><br>
			<div class=title><img src=img/logo_sub1.jpg>&nbsp;&nbsp;<img src=img/logo_psp.jpg>&nbsp;&nbsp;&nbsp;' . $this->serviceName. '</div>
			<div class=nav>
				<p>Servicio: <a href="'.$PHP_SELF.'?wsdl">WSDL</a>
				<br><br>Haga Click sobre el metodo para visualizar los detalles del mismo.</p>
				<ul>';
